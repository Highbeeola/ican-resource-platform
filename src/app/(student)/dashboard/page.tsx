  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-4 sm:p-6 md:p-10">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-400 font-extrabold text-xl flex items-center justify-center flex-shrink-0">
          ...
          <Link
            href="/resources"
            className="w-full md:w-auto px-6 py-3.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded-xl text-center text-xs sm:text-sm transition flex items-center justify-center gap-2 shadow-lg shadow-amber-500/10"
          >
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {subjects.slice(0, 6).map((sub) => (
              <div
                key={sub.id}
                className="bg-slate-950 border border-slate-800 rounded-2xl p-4 sm:p-5 space-y-3"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {favorites.map((fav: any) => {
                ...
                return (
                  ...
                  >
                    <span className="text-[10px] font-bold uppercase text-amber-400 px-2 py-0.5 bg-amber-500/10 rounded-full">
